...
- [x] Complexity analysis (Big‑O, Big‑Theta, Big‑Omega)
...
- [ ] Subarray problems (Kadane’s algorithm, prefix sums)
...
## 🌐 Stage 10: Sliding Window & Two Pointers
...
## ⚡ Stage 12: Greedy Algorithms
- [ ] Activity selection
- [ ] Huffman coding
- [ ] Minimum spanning tree problems

## 🌳 Stage 13: Binary Trees
- [ ] Traversals (inorder, preorder, postorder, level order)
- [ ] Diameter, height, balanced check
- [ ] Boundary traversal
- [ ] Medium and hard tree problems

## 🌲 Stage 14: Binary Search Trees
