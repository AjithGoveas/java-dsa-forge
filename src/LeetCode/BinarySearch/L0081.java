...
/// **Level:** Medium | **Pattern:** Modified binary search in rotated array with duplicates | **TC / SC:** O(log N) avg, O(N) worst / O(1)
/// **Trigger:** "search in rotated sorted array II", "duplicates"
/// **Traps:** Duplicate values cause mid ambiguity (shrink low/high); already sorted
