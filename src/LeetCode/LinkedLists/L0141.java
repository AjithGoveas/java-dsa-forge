...
/// **Level:** Easy | **Pattern:** Fast & Slow pointers (Floyd's cycle detection) | **TC / SC:** O(N) / O(1)
/// **Trigger:** "cycle in linked list", "detect cycle"
/// **Traps:** No cycle; cycle starts at head; single node; empty list
