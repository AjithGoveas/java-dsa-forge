...
/// **Level:** Hard | **Pattern:** In-place reversal of k-group (recursive/iterative) | **TC / SC:** O(N) / O(1)
/// **Trigger:** "reverse nodes in k-group", "leftover nodes keep order"
/// **Traps:** k > length (no change); k = 1; k = length (full reverse)
